        ...
        <div className="relative z-30">
            ...
            <div className="flex flex-col md:flex-row gap-10 justify-center items-center mt-10 ">
                {featuredRestaurants.map((featured) => (
                    <div key={featured.id} className="flex flex-col mb-4 bg-white justify-center items-center w-[270px] h-[350px] md:w-[270px] md:h-[300px] rounded-md shadow-2xl shadow-gray-500 z-20 mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-10 justify-center items-center mt-10">
                <Link to="/mealsd">
                    <div className="flex flex-col gap-2 bg-white justify-center items-center w-[270px] h-[350px] md:w-[200px] md:h-[280px] rounded-sm shadow-2xl shadow-gray-500 mx-auto">
